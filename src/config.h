...
#define THEME(theme, chess_theme)                                              \
	{                                                                          \
		...
		chess_theme[CHESS_COLOR_MOVED] = nk_rgba(140, 185, 80, 255);           \
                                                                               \
		chess_theme[CHESS_COLOR_1_HOVER] = nk_rgba(147, 147, 147, 255);        \
		chess_theme[CHESS_COLOR_2_HOVER] = nk_rgba(170, 128, 73, 255);         \
		chess_theme[CHESS_COLOR_MOVE_HOVER] = nk_rgba(170, 73, 73, 255);       \
		chess_theme[CHESS_COLOR_MOVED_HOVER] = nk_rgba(128, 170, 73, 255);     \
                                                                               \
		chess_theme[CHESS_COLOR_1_ACTIVE] = nk_rgba(138, 138, 138, 255);       \
		chess_theme[CHESS_COLOR_2_ACTIVE] = nk_rgba(160, 121, 69, 255);        \
		chess_theme[CHESS_COLOR_MOVE_ACTIVE] = nk_rgba(160, 69, 69, 255);      \
		chess_theme[CHESS_COLOR_MOVED_ACTIVE] = nk_rgba(121, 160, 69, 255);    \
